    ...
    function Registrar($request,$response)
    {
       ...
       // $puesto = $request->getParsedBody()['puesto'];
        ...
        $db = new PDO('mysql:host=localhost;dbname=id6888245_axelh21;charset=utf8', "id6888245_axelh21", "axelh21");
            ...
            $s =$db->prepare("SELECT * FROM prueba WHERE correo = :correo");
        ...
        $s =$db->prepare("INSERT INTO prueba (correo, clave,uno,dos,tres,cuatro,cinco)"
                                                . "VALUES(:correo,:clave,:uno,:dos,:tres,:cuatro,:cinco)");
    
            $s->bindValue(':correo', $correo, PDO::PARAM_STR);
            $s->bindValue(':clave', $clave, PDO::PARAM_INT);
            $s->bindValue(':uno', $uno, PDO::PARAM_INT);
            $s->bindValue(':dos', $dos, PDO::PARAM_INT);
            $s->bindValue(':tres', $tres, PDO::PARAM_INT);
            $s->bindValue(':cuatro', $cuatro, PDO::PARAM_INT);
            $s->bindValue(':cinco', $cinco, PDO::PARAM_INT);
    ...
    function Login($request,$response)
    {
       ...
       // $puesto = $request->getParsedBody()['puesto'];
        ...
        $db = new PDO('mysql:host=localhost;dbname=id6888245_axelh21;charset=utf8', "id6888245_axelh21", "axelh21");
         ...
         $s =$db->prepare("SELECT * FROM prueba WHERE correo = :correo AND clave = :clave");
                $s->bindValue(':correo', $correo, PDO::PARAM_STR);
                $s->bindValue(':clave', $clave, PDO::PARAM_INT);
                $s->execute();  
