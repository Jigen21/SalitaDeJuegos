...
@Component({
  selector: 'app-puntaje-segundo',
  templateUrl: './puntaje-segundo.component.html',
  styleUrls: ['./puntaje-segundo.component.css']
})
export class PuntajeSegundoComponent implements OnInit {
